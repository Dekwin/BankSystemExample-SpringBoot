...
public class JWTServiceImpl implements JWTService {
    ...
    public String getToken(CustomUserDetails user) throws Exception {
        ...
        tokenData.put("ssoId", user.getUser().getEmail());
    ...
    @Override
    public UserEntity addAuthentication(HttpServletResponse response, String ssoId, String password) throws Exception {
